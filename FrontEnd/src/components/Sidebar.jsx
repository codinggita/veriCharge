    ...
    <aside className="w-[260px] h-screen bg-[#0e0e0e] border-r border-[#222] flex flex-col justify-between hidden lg:flex shrink-0">
      <div>
        ...
        <nav className="flex flex-col mt-4">
          ...
          <Link to="/support" className={`flex items-center gap-4 px-8 py-4 border-l-4 transition-colors ${activePage === 'support' ? 'border-volt-green bg-volt-green/5 text-volt-green' : 'border-transparent text-neutral-400 hover:text-white hover:bg-[#161616]'}`}>
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
